...
> = ({
  ...
  return (
    <div
      className={`flex group relative items-start justify-between flex-col ${IAAIbetsInRealTimeItem.id === editing?.id ? "bg-blue-300/50" : "bg-white/50"} p-2 rounded-md shadow-md`}
    >
