...
export type IAAIcitiesAndPortsModalProps = {
  onClose: () => void;
  editCityAndPort: CityAndPortType | undefined;
  refetch: () => void;
};

const IAAIcitiesAndPortsSchema = z.object({
...
export const IAAIcitiesAndPortsEditModal: FC<IAAIcitiesAndPortsModalProps> = ({
  editCityAndPort,
  onClose,
  refetch,
}) => {
  ...
  const form = useForm({
    ...
    validators: {
      onChange: IAAIcitiesAndPortsSchema,
    },
    onSubmit: ({ value }) =>
      mutation.mutate({
        CA: value.CA,
